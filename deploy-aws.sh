...
# AWS Lambda deployment script for Deepdub TTS Proxy
set -e

echo "🚀 Deploying Deepdub TTS Proxy to AWS Lambda..."
...
if [ -z "$DEEPDUB_API_KEY" ] || [ -z "$DEEPDUB_VOICE_PROMPT_ID" ] || [ -z "$VAPI_SECRET" ]; then
    echo "❌ Missing required environment variables:"
    echo "   DEEPDUB_API_KEY: ${DEEPDUB_API_KEY:+Set}${DEEPDUB_API_KEY:-Not set}"
    echo "   DEEPDUB_VOICE_PROMPT_ID: ${DEEPDUB_VOICE_PROMPT_ID:+Set}${DEEPDUB_VOICE_PROMPT_ID:-Not set}"
